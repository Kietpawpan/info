...
| version 1.0.1 | Sep. 22, 2023 . Full-Stack Dev  ...|
|////////||\\\\\\\\\/////////||\\\\\\\///////||\\\\\\|
...
<input 
		...
		name="pin" 
		id="pinNo"
		style="width:150px;height:50px"><div id='pinNote' style="color:red;size=-1"></div>
</div>
...
$message = "ERROR 001: Incorrect PIN!";
$success = "Done! Thank you.";
$pinCode = $_POST['pin'];
if($data==' '){echo "<script type='text/javascript'>alert('$message');</script>";}
	elseif($pinCode!=="988&%"){echo "<script type='text/javascript'>alert('$message');</script>";}
	else{
